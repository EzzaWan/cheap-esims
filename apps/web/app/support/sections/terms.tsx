    ...
    <Card className="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
      <CardContent className="p-0">
        <div className="p-8 border-b border-gray-200 bg-gray-50">
          <h2 className="text-3xl font-bold text-black tracking-tight mb-2">Terms of Service</h2>
          <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 text-sm">
             <p className="text-gray-500 font-medium">
               Last updated: <span className="text-black font-semibold">{new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</span>
             </p>
        ...
        <div className="p-8 space-y-8 text-sm">
          <section>
            <h3 className="text-lg font-bold text-black mb-3 pb-1 border-b border-gray-100 inline-block">1. Definitions</h3>
            <div className="text-gray-600 space-y-2 ml-1">
              <p><strong className="text-black font-semibold">"Cheap eSIMs"</strong> refers to our eSIM marketplace platform and services.</p>
              <p><strong className="text-black font-semibold">"eSIM"</strong> refers to the electronic SIM profile provided through our platform.</p>
              <p><strong className="text-black font-semibold">"Service"</strong> refers to the eSIM data packages and related services we provide.</p>
              <p><strong className="text-black font-semibold">"User"</strong> refers to any person or entity using our services.</p>
            </div>
          </section>

          <section>
            <h3 className="text-lg font-bold text-black mb-3 pb-1 border-b border-gray-100 inline-block">2. Account Requirements</h3>
            <div className="text-gray-600 space-y-2 ml-1">
          ...
          <section>
            <h3 className="text-lg font-bold text-black mb-3 pb-1 border-b border-gray-100 inline-block">3. Usage Rules</h3>
            <div className="text-gray-600 space-y-2 ml-1">
          ...
          <section>
            <h3 className="text-lg font-bold text-black mb-3 pb-1 border-b border-gray-100 inline-block">4. Restrictions</h3>
            <div className="text-gray-600 space-y-2 ml-1">
          ...
          <section>
            <h3 className="text-lg font-bold text-black mb-3 pb-1 border-b border-gray-100 inline-block">5. Refund Rules</h3>
            <div className="text-gray-600 space-y-2 ml-1">
          ...
          <section>
            <h3 className="text-lg font-bold text-black mb-3 pb-1 border-b border-gray-100 inline-block">6. Top-Up Rules</h3>
            <div className="text-gray-600 space-y-2 ml-1">
          ...
          <section>
            <h3 className="text-lg font-bold text-black mb-3 pb-1 border-b border-gray-100 inline-block">7. Liability Limitations</h3>
            <div className="text-gray-600 space-y-2 ml-1">
          ...
          <section>
            <h3 className="text-lg font-bold text-black mb-3 pb-1 border-b border-gray-100 inline-block">8. Service Availability</h3>
            <div className="text-gray-600 space-y-2 ml-1">
          ...
          <section>
            <h3 className="text-lg font-bold text-black mb-3 pb-1 border-b border-gray-100 inline-block">9. Payment Terms</h3>
            <div className="text-gray-600 space-y-2 ml-1">
          ...
          <section>
            <h3 className="text-lg font-bold text-black mb-3 pb-1 border-b border-gray-100 inline-block">10. Contact Information</h3>
            <div className="text-gray-600 space-y-2 ml-1">
              <p>For questions about these Terms of Service, please contact us:</p>
              <p>• Support: <Link href="/support/contact" className="text-primary-dark font-bold hover:underline">Contact Form</Link></p>
