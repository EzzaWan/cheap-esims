  ...
  const troubleshootingItems: TroubleshootingItem[] = [
    {
      ...
      content: (
        <div className="space-y-4 text-sm">
          <div>
            <h4 className="font-bold mb-2">1. Enable Roaming</h4>
            <p className="text-gray-600 mb-3">
              eSIM requires data roaming to be enabled even when you're in the destination country.
            </p>
            <ul className="list-disc list-inside space-y-1 text-gray-600 ml-4">
              <li><strong className="text-gray-900">iPhone:</strong> Settings → Cellular → [Your eSIM] → Data Roaming (ON)</li>
              <li><strong className="text-gray-900">Android:</strong> Settings → Network & Internet → [Your eSIM] → Data Roaming (ON)</li>
            </ul>
          </div>

          <div>
            <h4 className="font-bold mb-2">2. Restart Your Device</h4>
          ...
          <div>
            <h4 className="font-bold mb-2">3. Reinstall eSIM Profile</h4>
            <p className="text-gray-600 mb-3">
              If roaming is enabled but still no connection, try removing and reinstalling the eSIM:
            </p>
            <ul className="list-disc list-inside space-y-1 text-gray-600 ml-4">
              <li><strong className="text-gray-900">iPhone:</strong> Settings → Cellular → [Your eSIM] → Remove Cellular Plan</li>
              <li><strong className="text-gray-900">Android:</strong> Settings → SIM card manager → Remove eSIM</li>
              <li>Then reinstall using the QR code or activation code from your Cheap eSIMs account</li>
            </ul>
          </div>

          <div>
            <h4 className="font-bold mb-2">4. Configure APN Settings</h4>
            <p className="text-gray-600 mb-3">
              Some networks require manual APN configuration:
            </p>
            <ul className="list-disc list-inside space-y-1 text-gray-600 ml-4">
              <li>Go to your device's network settings for the eSIM</li>
              <li>Add a new APN with the name: <strong className="text-gray-900">internet</strong></li>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4 text-sm">
          <div>
            <h4 className="font-bold mb-2">1. Brighten Your Screen</h4>
            <p className="text-gray-600">
          ...
          <div>
            <h4 className="font-bold mb-2">2. Use Fullscreen Mode</h4>
            <p className="text-gray-600">
          ...
          <div>
            <h4 className="font-bold mb-2">3. Download and Print QR Code</h4>
            <p className="text-gray-600 mb-3">
          ...
          <div>
            <h4 className="font-bold mb-2">4. Use Manual Entry</h4>
            <p className="text-gray-600">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4 text-sm">
          <div>
            <h4 className="font-bold mb-2">1. Verify Correct Region</h4>
            <p className="text-gray-600">
          ...
          <div>
            <h4 className="font-bold mb-2">2. Wait 2 Minutes After Purchase</h4>
            <p className="text-gray-600">
          ...
          <div>
            <h4 className="font-bold mb-2">3. Copy Activation Code Correctly</h4>
            <p className="text-gray-600 mb-3">
          ...
          <div>
            <h4 className="font-bold mb-2">4. Try QR Code Method</h4>
            <p className="text-gray-600">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4 text-sm">
          <div>
            <h4 className="font-bold mb-2">1. Check Background App Sync</h4>
            <p className="text-gray-600 mb-3">
          ...
          <div>
            <h4 className="font-bold mb-2">2. Avoid Using Hotspot</h4>
            <p className="text-gray-600">
          ...
          <div>
            <h4 className="font-bold mb-2">3. Monitor Data Usage</h4>
            <p className="text-gray-600 mb-3">
              Check your data usage regularly:
            </p>
            <ul className="list-disc list-inside space-y-1 text-gray-600 ml-4">
              <li><strong className="text-gray-900">iPhone:</strong> Settings → Cellular → View data usage per app</li>
              <li><strong className="text-gray-900">Android:</strong> Settings → Network & Internet → Data usage</li>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4 text-sm">
          <div>
            <h4 className="font-bold mb-2">1. Verify Device Compatibility</h4>
            <p className="text-gray-600 mb-3">
              Use our device compatibility checker to confirm if your device supports eSIM:
            </p>
            <Link href="/support/device-check">
              <Button className="bg-black hover:bg-gray-800 border border-black text-white rounded-full font-bold shadow-lg hover:shadow-xl transition-all">
          ...
          <div>
            <h4 className="font-bold mb-2">2. Common Incompatible Models</h4>
            <p className="text-gray-600 mb-3">
          ...
          <div>
            <h4 className="font-bold mb-2">3. Check Carrier Lock Status</h4>
            <p className="text-gray-600">
    ...
    <div className="space-y-6">
      <div className="relative group">
        ...
        <Input
          ...
          className="pl-12 h-14 bg-white border border-gray-200 rounded-full shadow-sm focus-visible:ring-2 focus-visible:ring-primary/20 focus-visible:border-primary text-gray-900 placeholder:text-gray-400 font-medium text-base transition-all"
        />
      </div>
      ...
      {filteredItems.length === 0 ? (
        ...
        <Accordion type="single" collapsible className="w-full space-y-4">
          {filteredItems.map((item) => (
            <AccordionItem key={item.id} value={item.id} className="border border-gray-200 bg-white rounded-2xl shadow-sm overflow-hidden hover:shadow-md transition-all">
              <AccordionTrigger className="text-gray-900 font-bold text-left hover:bg-gray-50 hover:no-underline px-6 py-5 [&[data-state=open]]:bg-gray-50 text-base md:text-lg">
                {item.title}
              </AccordionTrigger>
              <AccordionContent className="bg-white px-6 py-6 border-t border-gray-100 text-gray-700 leading-relaxed">
                 {item.content}
              </AccordionContent>
            </AccordionItem>
          ))}
